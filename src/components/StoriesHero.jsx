  ...
  return (
    <div className={styles.storiesHeroContainer}>
        ...
        <div className={styles.textbox}>
            <h4 className={`h4 ${styles.marginBottom24px} `}>LAST MONTH’S FEATURED STORY</h4>
            <h1 className={`${styles.marginBottom16px} ${styles.heading}`}>HAZY FULL <br /> MOON OF <br /> APPALACHIA</h1>
            <p className={`p2 ${styles.marginBottom24px}`}><span className={styles.textOpacity}>March 2nd 2020 </span>by John Appleseed</p>
            <p className={`p ${styles.textOpacity} ${styles.marginBottom24px}`}>
            ...
            <Link className={`h4 link2 ${styles.link}`}>
                <p className={styles.linkText}>Read the story</p>
